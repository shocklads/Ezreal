...
namespace AddonTemplate
{
    public static class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            Obj_AI_Base.OnBasicAttack += ObjTurret_OnTurretDamage;
        }

        private static void ObjTurret_OnTurretDamage(Obj_AI_Base sender, GameObjectProcessSpellCastEventArgs args)
        {
            if (sender is Obj_AI_Turret && sender.IsAlly)
            {
                ...
                if (Player.Instance.GetAutoAttackDamage(lol) < lol.Health && Player.Instance.GetSpellDamage(lol, SpellSlot.Q) > lol.Health && Player.Instance.CanAttack)
                {
                    string[] innerTurret = new string[]{
              "TurreT_T2_C_01_A",
              "TurreT_T2_C_02_A",
              "TurreT_T2_L_01_A",
              "TurreT_T2_C_03_A",
        ...
        private static void OnLoadingComplete(EventArgs args)
        {
            ...
            Config.Modes.Misc._SelfW.OnValueChange += SelfW_OnValueChanged;
        }
